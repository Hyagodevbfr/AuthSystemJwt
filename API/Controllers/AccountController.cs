...
namespace API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        [Authorize]
        [HttpGet("detail")]
        public async Task<ActionResult<UserDatailDto>> GetUserDetail()
        {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<UserDatailDto>>> GetUsers()
        {
            var users = await _userManager.Users.Select(u => new UserDatailDto
            {
                Id = u.Id,
                Email = u.Email,
                FullName = u.FullName,
